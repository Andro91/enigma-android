...
public class SplashActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Crossword one = new Crossword(1,1,0,"MaKaBiiSiDoRLaKeJiaMaNeTNaRoViaRaMiS","NO","0", "sr");
        Crossword two = new Crossword(2,2,0,"KLaSiKRaSiNaaVaTaRToMaTaaRaRaTKiRiNe","NO","0", "sr");
        Crossword three = new Crossword(3,3,0,"PoSKoKoRLiNaTMuRaNKaLiTioRaNaCPiJeSa","NO","0", "sr");
        Crossword four = new Crossword(4,4,0,"VaSKRSeMeRiTNaJaVaSTaMeNKoTaRaiLiRaC","NO","0", "sr");
        Crossword five = new Crossword(5,5,0,"ZaKuPiiZaZoVMiLoJaSMiReNKuKaWeiToNaC","NO","0", "sr");
        Crossword six = new Crossword(6,6,0,"PaPKaRoTRoViTRePeTKoMiTioPoJaNPaRaNa","NO","0", "sr");
        Crossword seven = new Crossword(7,7,0,"BoRaKSoToLiTKaMaRaaKaDeMSaNaNaaRaRaT","NO","0", "sr");
        Crossword eight = new Crossword(8,8,0,"MaKaKiaNaTaSLiPaZaaMaNaTGuRaTiaSaSiN","NO","0", "sr");
        Crossword nine = new Crossword(9,9,0,"aLPaKaPaRDoNDuGaRaaTaLiKJaViTiKRoNiN","NO","0", "sr");
        Crossword ten = new Crossword(10,10,0,"KLaSaRRaRoZiaNaMiTNaGoJaKRoVaRLaNiCi","NO","0", "sr");
